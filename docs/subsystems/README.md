...
| [command-center.md](command-center.md) | durable project-serialized task ownership, confined Pi/Codex/OpenClaw execution, and local browser and Discord control |
| [todo.md](todo.md) | the todo package's whole-list item type, durable event ownership, projection, and open-turn invariant |
| [solo-factory.md](solo-factory.md) | the manual issue-to-pull-request lifecycle, retained worktrees, versioned history, failed-stage resume, and pull-request human gate |
