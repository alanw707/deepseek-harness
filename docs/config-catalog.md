...
Requires: `webServer` · `taskControl` · `taskExecution` · `connection`
...
Source: [`packages/host/task-dashboard/src/index.ts:23`](../packages/host/task-dashboard/src/index.ts)
...
Requires: `sandbox` · `subprocess` · `taskControl` · `workspaceRegistry`
...
Source: [`packages/workspace/task-execution/src/index.ts:57`](../packages/workspace/task-execution/src/index.ts)
...
Depends on: [`SoloFactoryConfig`](../packages/factory/solo-factory/src/index.ts)

Source: [`packages/factory/tool-solo-factory/src/index.ts:14`](../packages/factory/tool-solo-factory/src/index.ts)
...
- `@deepseek-ai/dsh-task-control` — requires `storageDomain` · `workspaceRegistry` ([`packages/workspace/task-control/src/index.ts`](../packages/workspace/task-control/src/index.ts))
