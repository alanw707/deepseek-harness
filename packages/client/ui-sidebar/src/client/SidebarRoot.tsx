 ...
 * settings control only fades. Primary actions sit between New Session and
 * the `sidebar.workspaces` browsing region; the foot holds `sidebar.settings`
 * plus `sidebar.footer.action`. The shell hands each occupant the wide flag
  ...
  return (
    ...
    >
      ...
      <div className={css.primaryActions}>
        {renderSlot('sidebar.primary.action', { wide, className: css.primaryAction })}
      </div>
