...
| [`codex`](codex/README.zh.md) | 为 Codex profile 选择 Codex OAuth 模型 | —（仅 patch） |
...
| [`solo-factory`](solo-factory/README.zh.md) | solo-factory profile 的 issue 到 pull request 自动化 | 挂载 `tool-solo-factory` |
