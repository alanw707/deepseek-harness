...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  taskControl: 'command-center.md',
  taskDashboard: 'command-center.md',
  taskExecution: 'command-center.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  Task: 'command-center.md',
  CommandCenterProject: 'command-center.md',
  TaskChangeSet: 'command-center.md',
  TaskChangeSetReference: 'command-center.md',
  TaskChangeState: 'command-center.md',
  TaskCopyReference: 'command-center.md',
  TaskId: 'command-center.md',
  TaskRequest: 'command-center.md',
  TerminalTaskState: 'command-center.md',
